				...
				\context Voice = "Piano Upper Voice" {
					...
					}
					{
						\times 2/3 {
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 1
							<c' e' g' b' d''>8 -\accent -\staccato \mf [
								^ \markup {
									\center-align
										\concat
											{
				...
				\context Voice = "Piano Lower Voice" {
					...
					}
					{
						\times 4/5 {
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 1
							<d' f' a' c'' e''>8 -\accent -\staccato \mf [
								^ \markup {
									\center-align
										\concat
											{
