				...
				\context Voice = "Piano Upper Voice" {
					...
					{
						{
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 2
							<c' e' g' b' d''>16 -\accent -\staccato \ppp [
								^ \markup {
									\center-align
										\concat
											{
					...
					}
					{
						...
						}
						{
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 2
							<f' a' c'' e'' g''>16 -\accent -\staccato \p [
								^ \markup {
									\center-align
										\concat
											{
					...
					{
						{
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 2
							<e' g' b' d''>16 -\accent -\staccato \ppp [
								^ \markup {
									\center-align
										\concat
											{
				...
				\context Voice = "Piano Lower Voice" {
					...
					{
						{
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 2
							<d' f' a' c'' e''>16 -\accent -\staccato \ppp [
								^ \markup {
									\center-align
										\concat
											{
					...
					}
					{
						...
						}
						{
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 2
							<a c' e' g' b'>16 -\accent -\staccato \p [
								^ \markup {
									\center-align
										\concat
											{
					...
					{
						{
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 2
							<a c' e' g' b'>16 -\accent -\staccato \ppp [
								^ \markup {
									\center-align
										\concat
											{
					...
					}
					{
						...
						}
						{
							...
							\set stemLeftBeamCount = 0
							\set stemRightBeamCount = 2
							<c' e' g' b' d''>16 -\accent -\staccato \p [
								^ \markup {
									\center-align
										\concat
											{
