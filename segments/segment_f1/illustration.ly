				...
				\context OboeStaff = "Oboe Staff" {
					\context Voice = "Oboe Voice" {
						...
						}
						{
							{
								\pitchedTrill
								c'''8 -\accent \p \startTrillSpan ef'''
								<> \stopTrillSpan
							}
						}
						{
